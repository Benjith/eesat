          ...
          <div class="row">
            ...
            <div class="col-lg-6 bg-white">
              <div class="form d-flex align-items-center">
                <div class="content">
                   <form id='login-form' method="post" action="<?php echo site_url(); ?>/login/login_check"> 
                    ...
                    <div class="form-group">
                      ...
                      </div><input type='submit'  class="btn btn-primary" name="insert" value="Login"> <?php echo '<label class="text-danger">'.$this->session->flashdata

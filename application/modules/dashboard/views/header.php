<header class="header">
        <nav class="navbar" style="background-color:#796aeee6; ">
          <!-- Search Box-->
            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div class="navbar-header">
                <!-- Navbar Brand --><a href="<?php echo site_url(); ?>" class="navbar-brand">
                  <div class="brand-text brand-big"><span>EESAT</span><strong>&nbsp;Dashboard</strong></div>
                  <div class="brand-text brand-small"><strong>Esat</strong></div></a>
